...
In this post we will see how many of the classical test statistics ( such as $$z, t, F$$) come from viewing a random sample as defining a vector in space, and understanding the geometry of such vectors.
